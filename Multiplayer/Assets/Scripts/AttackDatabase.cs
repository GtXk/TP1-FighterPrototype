...
public class AttackDatabase : MonoBehaviour
{
    ...
    public void SetUP() //easy to implement new attacks - simply adding to the database
    {
        ...
        allAttacksDatabase[0] = new Attack("Punch", "Basic", 8, 98, 0, -5); //attacks then will be retrieve as a set of 4. For the attackset script because each player has 1 attack set (which contains 4 attacks).
        ...
        allAttacksDatabase[4] = new Attack("Kick", "Basic", 8, 98, 0, -5);
        ...
        allAttacksDatabase[8] = new Attack("Dropkick", "Basic", 8, 98, 0, -5);
        ...
        allAttacksDatabase[12] = new Attack("Headbutt", "Basic", 8, 98, 0, -5);
